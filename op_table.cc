...
#define unofficial_rmw &CPU::unofficial_rmw
...
/* 0x01 */ ORA<IDX>,
/* 0x02 */ BAD_OP,
/* 0x03 */ unofficial_rmw<ASL<IDX>,ORA<IDX>>,//SLO
/* 0x04 */ NOP<IMM>,
/* 0x05 */ ORA<ZPG>,
/* 0x06 */ ASL<ZPG>,
/* 0x07 */ unofficial_rmw<ASL<ZPG>,ORA<ZPG>>,//SLO
/* 0x08 */ stack_push<ProcStatus>,	
/* 0x09 */ ORA<IMM>,
/* 0x0A */ ASL<ACC>,
/* 0x0B */ unofficial<AND<IMM>,copyflag<N_FLAG,C_FLAG>>,//ANC
/* 0x0C */ NOP<ABS>,
/* 0x0D */ ORA<ABS>,
/* 0x0E */ ASL<ABS>,
/* 0x0F */ unofficial_rmw<ASL<ABS>,ORA<ABS>,2>,//SLO
/* 0x10 */ branch<if_clear<N_FLAG>>,
/* 0x11 */ ORA<IDY_pgx>,
/* 0x12 */ BAD_OP,
/* 0x13 */ unofficial_rmw<ASL<IDY>,ORA<IDY>>,//SLO
/* 0x14 */ NOP<ZPX>,
/* 0x15 */ ORA<ZPX>,
/* 0x16 */ ASL<ZPX>,
/* 0x17 */ unofficial_rmw<ASL<ZPX>,ORA<ZPX>>,//SLO
/* 0x18 */ clear<C_FLAG>,
/* 0x19 */ ORA<ABY_pgx>,
/* 0x1A */ NOP,
/* 0x1B */ unofficial_rmw<ASL<ABY>,ORA<ABY>,2>,//SLO
/* 0x1C */ NOP<ABX_pgx>,
/* 0x1D */ ORA<ABX_pgx>,
/* 0x1E */ ASL<ABX>,
/* 0x1F */ unofficial_rmw<ASL<ABX>,ORA<ABX>,2>,//SLO
/* 0x20 */ JSR,
/* 0x21 */ AND<IDX>,
/* 0x22 */ BAD_OP,
/* 0x23 */ unofficial_rmw<ROL<IDX>,AND<IDX>>,//RLA
/* 0x24 */ BIT<ZPG>,
/* 0x25 */ AND<ZPG>,
/* 0x26 */ ROL<ZPG>,
/* 0x27 */ unofficial_rmw<ROL<ZPG>,AND<ZPG>>,//RLA
/* 0x28 */ stack_pull<ProcStatus>,
/* 0x29 */ AND<IMM>,
/* 0x2A */ ROL<ACC>,
/* 0x2B */ unofficial<AND<IMM>,copyflag<N_FLAG,C_FLAG>>,//ANC
/* 0x2C */ BIT<ABS>,
/* 0x2D */ AND<ABS>,
/* 0x2E */ ROL<ABS>,
/* 0x2F */ unofficial_rmw<ROL<ABS>,AND<ABS>,2>,//RLA
/* 0x30 */ branch<if_set<N_FLAG>>,
/* 0x31 */ AND<IDY_pgx>,
/* 0x32 */ BAD_OP,
/* 0x33 */ unofficial_rmw<ROL<IDY>,AND<IDY>>,//RLA
/* 0x34 */ NOP<ZPX>,
/* 0x35 */ AND<ZPX>,
/* 0x36 */ ROL<ZPX>,
/* 0x37 */ unofficial_rmw<ROL<ZPX>,AND<ZPX>>,//RLA
/* 0x38 */ set<C_FLAG>,
/* 0x39 */ AND<ABY_pgx>,
/* 0x3A */ NOP,
/* 0x3B */ unofficial_rmw<ROL<ABY>,AND<ABY>,2>,//RLA
/* 0x3C */ NOP<ABX_pgx>,
/* 0x3D */ AND<ABX_pgx>,
/* 0x3E */ ROL<ABX>,
/* 0x3F */ unofficial_rmw<ROL<ABX>,AND<ABX>,2>,//RLA
/* 0x40 */ RTI,
/* 0x41 */ EOR<IDX>,
/* 0x42 */ BAD_OP,
/* 0x43 */ unofficial_rmw<LSR<IDX>,EOR<IDX>>,//SRE
/* 0x44 */ NOP<IMM>,
/* 0x45 */ EOR<ZPG>,
/* 0x46 */ LSR<ZPG>,
/* 0x47 */ unofficial_rmw<LSR<ZPG>,EOR<ZPG>>,//SRE
/* 0x48 */ stack_push<Accumulator>,
/* 0x49 */ EOR<IMM>,
/* 0x4A */ LSR<ACC>,
/* 0x4B */ unofficial<AND<IMM>,LSR<ACC>>, // ALR
/* 0x4C */ jump<ABS>,
/* 0x4D */ EOR<ABS>,
/* 0x4E */ LSR<ABS>,
/* 0x4F */ unofficial_rmw<LSR<ABS>,EOR<ABS>,2>,//SRE
/* 0x50 */ branch<if_clear<V_FLAG>>,
/* 0x51 */ EOR<IDY_pgx>,
/* 0x52 */ BAD_OP,
/* 0x53 */ unofficial_rmw<LSR<IDY>,EOR<IDY>>,//SRE
/* 0x54 */ NOP<ZPX>,
/* 0x55 */ EOR<ZPX>,
/* 0x56 */ LSR<ZPX>,
/* 0x57 */ unofficial_rmw<LSR<ZPX>,EOR<ZPX>>,//SRE
/* 0x58 */ clear<I_FLAG>,
/* 0x59 */ EOR<ABY_pgx>,
/* 0x5A */ NOP,
/* 0x5B */ unofficial_rmw<LSR<ABY>,EOR<ABY>,2>,//SRE
/* 0x5C */ NOP<ABX_pgx>,
/* 0x5D */ EOR<ABX_pgx>,
/* 0x5E */ LSR<ABX>,
/* 0x5F */ unofficial_rmw<LSR<ABX>,EOR<ABX>,2>,//SRE
/* 0x60 */ RTS,
/* 0x61 */ ADC<IDX>,
/* 0x62 */ BAD_OP,
/* 0x63 */ unofficial_rmw<ROR<IDX>,ADC<IDX>>,//RRA
/* 0x64 */ NOP<IMM>,
/* 0x65 */ ADC<ZPG>,
/* 0x66 */ ROR<ZPG>,
/* 0x67 */ unofficial_rmw<ROR<ZPG>,ADC<ZPG>>,//RRA
/* 0x68 */ stack_pull<Accumulator>,
/* 0x69 */ ADC<IMM>,
/* 0x6A */ ROR<ACC>,
/* 0x6B */ unofficial<AND<IMM>,ROR<ACC>>,//ARR
/* 0x6C */ jump<IND>,
/* 0x6D */ ADC<ABS>,
/* 0x6E */ ROR<ABS>,
/* 0x6F */ unofficial_rmw<ROR<ABS>,ADC<ABS>,2>,//RRA
/* 0x70 */ branch<if_set<V_FLAG>>,
/* 0x71 */ ADC<IDY_pgx>,
/* 0x72 */ BAD_OP,
/* 0x73 */ unofficial_rmw<ROR<IDY>,ADC<IDY>>,//RRA
/* 0x74 */ NOP<ZPX>,
/* 0x75 */ ADC<ZPX>,
/* 0x76 */ ROR<ZPX>,
/* 0x77 */ unofficial_rmw<ROR<ZPX>,ADC<ZPX>>,//RRA
/* 0x78 */ set<I_FLAG>,
/* 0x79 */ ADC<ABY_pgx>,
/* 0x7A */ NOP,
/* 0x7B */ unofficial_rmw<ROR<ABY>,ADC<ABY>,2>,//RRA
/* 0x7C */ NOP<ABX_pgx>,
/* 0x7D */ ADC<ABX_pgx>,
/* 0x7E */ ROR<ABX>,
/* 0x7F */ unofficial_rmw<ROR<ABX>,ADC<ABX>,2>,//RRA
/* 0x80 */ NOP<ZPG>,
...
/* 0xA3 */ unofficial<load<Accumulator,IDX>,transfer<Accumulator,IndexRegX>>,//LAX
/* 0xA4 */ load<IndexRegY,ZPG>,
/* 0xA5 */ load<Accumulator,ZPG>,
/* 0xA6 */ load<IndexRegX,ZPG>,
/* 0xA7 */ unofficial<load<Accumulator,ZPG>,transfer<Accumulator,IndexRegX>>,//LAX
/* 0xA8 */ transfer<Accumulator,IndexRegY>,
/* 0xA9 */ load<Accumulator,IMM>,
/* 0xAA */ transfer<Accumulator,IndexRegX>,
/* 0xAB */ unofficial<load<Accumulator,IMM>,transfer<Accumulator,IndexRegX>>,//LAX
/* 0xAC */ load<IndexRegY,ABS>,
/* 0xAD */ load<Accumulator,ABS>,
/* 0xAE */ load<IndexRegX,ABS>,
/* 0xAF */ unofficial<load<Accumulator,ABS>,transfer<Accumulator,IndexRegX>>,//LAX
/* 0xB0 */ branch<if_set<C_FLAG>>,
/* 0xB1 */ load<Accumulator,IDY_pgx>,
/* 0xB2 */ BAD_OP,
/* 0xB3 */ unofficial<load<Accumulator,IDY_pgx>,transfer<Accumulator,IndexRegX>>,//LAX
/* 0xB4 */ load<IndexRegY,ZPX>,
/* 0xB5 */ load<Accumulator,ZPX>,
/* 0xB6 */ load<IndexRegX,ZPY>,
/* 0xB7 */ unofficial<load<Accumulator,ZPY>,transfer<Accumulator,IndexRegX>>,//LAX
/* 0xB8 */ clear<V_FLAG>,
...
/* 0xBF */ unofficial<load<Accumulator,ABY_pgx>,transfer<Accumulator,IndexRegX>>,//LAX
/* 0xC0 */ compare<IndexRegY,IMM>,
/* 0xC1 */ compare<Accumulator,IDX>,
/* 0xC2 */ BAD_OP,
/* 0xC3 */ unofficial_rmw<DEC<IDX>,compare<Accumulator,IDX>>,//DCP
/* 0xC4 */ compare<IndexRegY,ZPG>,
/* 0xC5 */ compare<Accumulator,ZPG>,
/* 0xC6 */ DEC<ZPG>,
/* 0xC7 */ unofficial_rmw<DEC<ZPG>,compare<Accumulator,ZPG>>,//DCP
/* 0xC8 */ INC<Y__>,
...
/* 0xCE */ DEC<ABS>,
/* 0xCF */ unofficial_rmw<DEC<ABS>,compare<Accumulator,ABS>,2>,//DCP
/* 0xD0 */ branch<if_clear<Z_FLAG>>,
/* 0xD1 */ compare<Accumulator,IDY_pgx>,
/* 0xD2 */ BAD_OP,
/* 0xD3 */ unofficial_rmw<DEC<IDY>,compare<Accumulator,IDY>>,//DCP
/* 0xD4 */ NOP<ZPX>,
/* 0xD5 */ compare<Accumulator,ZPX>,
/* 0xD6 */ DEC<ZPX>,
/* 0xD7 */ unofficial_rmw<DEC<ZPX>,compare<Accumulator,ZPX>>,//DCP
/* 0xD8 */ clear<D_FLAG>,
/* 0xD9 */ compare<Accumulator,ABY_pgx>,
/* 0xDA */ NOP,
/* 0xDB */ unofficial_rmw<DEC<ABY>,compare<Accumulator,ABY>,2>,//DCP
/* 0xDC */ NOP<ABX_pgx>,
/* 0xDD */ compare<Accumulator,ABX_pgx>,
/* 0xDE */ DEC<ABX>,
/* 0xDF */ unofficial_rmw<DEC<ABX>,compare<Accumulator,ABX>,2>,//DCP
/* 0xE0 */ compare<IndexRegX,IMM>,
/* 0xE1 */ SBC<IDX>,
/* 0xE2 */ BAD_OP,
/* 0xE3 */ unofficial_rmw<INC<IDX>,SBC<IDX>>,//ISB(ISC)
/* 0xE4 */ compare<IndexRegX,ZPG>,
/* 0xE5 */ SBC<ZPG>,
/* 0xE6 */ INC<ZPG>,
/* 0xE7 */ unofficial_rmw<INC<ZPG>,SBC<ZPG>>,//ISB(ISC)
/* 0xE8 */ INC<X__>,
/* 0xE9 */ SBC<IMM>,
/* 0xEA */ NOP,
/* 0xEB */ SBC<IMM>,
...
/* 0xED */ SBC<ABS>,
/* 0xEE */ INC<ABS>,
/* 0xEF */ unofficial_rmw<INC<ABS>,SBC<ABS>,2>,//ISB(ISC)
/* 0xF0 */ branch<if_set<Z_FLAG>>,
/* 0xF1 */ SBC<IDY_pgx>,
/* 0xF2 */ BAD_OP,
/* 0xF3 */ unofficial_rmw<INC<IDY>,SBC<IDY>>,//ISB(ISC)
/* 0xF4 */ NOP<ZPX>,
/* 0xF5 */ SBC<ZPX>,
/* 0xF6 */ INC<ZPX>,
/* 0xF7 */ unofficial_rmw<INC<ZPX>,SBC<ZPX>>,//ISB(ISC)
/* 0xF8 */ set<D_FLAG>,
/* 0xF9 */ SBC<ABY_pgx>,
/* 0xFA */ NOP,
/* 0xFB */ unofficial_rmw<INC<ABY>,SBC<ABY>,2>,//ISB(ISC)
/* 0xFC */ NOP<ABX_pgx>,
/* 0xFD */ SBC<ABX_pgx>,
/* 0xFE */ INC<ABX>,
/* 0xFF */ unofficial_rmw<INC<ABX>,SBC<ABX>,2>//ISB(ISC)
};
